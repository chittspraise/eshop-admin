...
import { createCategory, imageUploadHandler, updateCategory, deleteCategory } from '@/actions/categories';
...
const CategoriesPageComponent: FC<Props> = ({ categories }) => {
  ...
  return (
    <main className='grid flex-1 items-start gap-4 p-4 sm:px-6 sm:py-8 md:gap-6'>
            ...
            <TableBody>
                ...
                <CategoryTableRow
                  ...
                  deleteCategoryHandler={deleteCategoryHandler}
                    // Implement the delete category handler logic here
